    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rent_car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rent_car', to='main_page.detailcar', verbose_name='Аренда машины')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renter', to=settings.AUTH_USER_MODEL, verbose_name='Арендатор')),
            ],
            options={
